...
<!-- u_id u_username u_password u_sex u_phone u_cardType u_address u_wallet -->
	<form action="regist.action" method="post">
		...
		name="u_username">
		<!-- onblur="self.location='testname.action?u_username='+$(this).val()+'&u_password='+$('#u_password').val()+'&u_sex='+$('#u_sex').val()+'&u_phone='+$('#u_phone').val()+'&u_cardType='+$('#u_cardType').val()+'&u_address='+$('#u_address').val()+'&u_wallet='+$('#u_wallet').val()" -->
			<span id="name_msg">
